...
- Entity header
- Journey progress
- Tabs: Overview, Documents, Eligibility, Interview, Background, History
- Contextual actions
- Internal notes
...
- Onboarding tasks
- Training
- Matching readiness blockers
- Case notes
- History

## Placement workspace

- Participant and host summary
- Placement lifecycle
- Tabs: Overview, Schedule, Hours, Evaluations, Incidents, Case Notes, Documents, Funding, History
- Activation blockers and actions

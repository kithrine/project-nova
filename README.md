# Project Nova Documentation

This repository-ready documentation bundle is the source of truth for Project Nova planning.

## Start here

1. `PROJECT_CONTEXT.md`
2. `docs/planning/project-blueprint.md`
...
These documents represent the approved planning baseline before implementation. Items labeled **Open**, **Needs validation**, or **Legal review required** are intentionally unresolved.
